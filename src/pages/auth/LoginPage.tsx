            ...
            <div className="w-full h-full mt-3.5 flex justify-center items-center">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stop-color="#84DFFF"></stop>
                    <stop offset="0.599" stop-color="#fff"></stop>
                  </linearGradient>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop offset="0.41" stop-color="#F5CF54"></stop>
                    <stop offset="0.85" stop-color="#84DFFF"></stop>
                  </linearGradient>
                  <radialGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop offset="0.54" stop-color="#F5CF54"></stop>
                    <stop offset="0.89" stop-color="#EB8865"></stop>
                  </radialGradient>
                </defs>
              </svg>
            </div>
