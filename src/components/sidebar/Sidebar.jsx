    ...
    <div className="h-screen dark:bg-slate-950">
      <div className="flex flex-col gap-3 w-full text-slate-300 h-full justify-between">
        <div className="flex flex-col gap-10 px-4 mt-4">
          ...
          <span className="text-sm font-bold sm:text-sm text-blue-100 text-center">Welcome to, Vodth!</span>
          {/* <div className="hidden md:flex font-bold sm:text-sm text-blue-100 mt-1">
            <span className="text-sm mb-10">Welcome to, Vodth!</span>
          </div> */}
          <div className="flex flex-col gap-5 text-md sm:text-sm lg:text-lg">
            <div className="flex items-center gap-2">
              <div><AiOutlineDashboard></AiOutlineDashboard></div>
